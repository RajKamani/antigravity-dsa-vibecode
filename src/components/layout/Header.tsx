...
export const Header: React.FC = () => {
  ...
  return (
    <header className="h-14 flex items-center justify-between px-6 bg-[var(--c-panel)] border-b border-[var(--c-border)] sticky top-0 z-30 transition-colors" role="banner">
